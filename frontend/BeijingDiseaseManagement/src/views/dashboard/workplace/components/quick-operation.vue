...
<script lang="ts" setup>
  const links = [
    { text: 'workplace.contentManagement', icon: 'icon-user' },
    { text: 'workplace.contentStatistical', icon: 'icon-bar-chart' },
    { text: 'workplace.advanced', icon: 'icon-settings' },
    { text: 'workplace.onlinePromotion', icon: 'icon-heart' },
    { text: 'workplace.contentPutIn', icon: 'icon-calendar' },
  ];
</script>
